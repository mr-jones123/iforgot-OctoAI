...
function buildDefaultColumns(boardId: string): ColumnType[] {
...
export function Board({ workspace }: BoardProps) {
	const boardId = workspace.id;
	const [columns] = useState<ColumnType[]>(() => buildDefaultColumns(boardId));
